...
public class CarPopulation : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        /*
        float[] good00 = new float[] {0.1971179f, -0.7873962f, -0.1772171f, 0.3655338f, 0.8897562f,0};
        float[] good01 = new float[] {-0.9953563f, 0.4975347f, -0.7351885f, -0.3298408f, 0.7022059f,0};
        float[] good02 = new float[] {0.9550359f, 0.1878072f, 0.2774045f, -0.932277f, 0.002232909f,0};
        float[] good03 = new float[] {0.4231319f, -0.1798769f, -0.1396383f, -0.6100574f, -0.8416488f,0};
        float[] good04 = new float[] {0.8465564f, 0.497458f, 0.1564225f, -0.9475875f, -0.9111381f,0};
        float[] good05 = new float[] {-0.3780454f, -0.2332152f, -0.128101f, -0.1601473f, 0.09461606f,0};
        float[] good06 = new float[] {-0.1294144f, 0.3694024f, -0.1567475f, 0.7233827f, 0.4618244f,0};
        float[] good07 = new float[] {-0f, 0f, -0f, 0f, 0f,0};
        ...
        float[] good15 = new float[] {0f, 0f};

        float[][] good0 = new float[][] {good00, good01, good02, good03, good04, good05, good06, good07};
        float[][] good1 = new float[][] {good10, good11, good12, good13, good14, good15};
